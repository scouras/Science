...
our %CONFIG_ANAL = (
  ...
  queue           => 'opterons',
  #queue           => 'analysis',
  plot            => "/users/scouras/code/scouras/plot_contact",
...
sub Get_Jobs {
  ...
  # Currently only do CONTACT on whole molecules
  ...
  $job->{'line'      } = "contact $REGION->{'index'} $ANAL->{'reference'}";
